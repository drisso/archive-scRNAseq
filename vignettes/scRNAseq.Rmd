...
The dataset `shalek_dc` contains 2397 dendritic cells from [@shalek2014single] (SRA: SRP027537). (Note that our preprocessing pipeline failed to process 28 out of the original 2425 samples).
